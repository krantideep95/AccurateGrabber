...
public class UserReport extends javax.swing.JFrame {
    ...
    public UserReport(ServerService serverThread,
    ...
    private void showTable(ArrayList al) {
        String h[] = {"userid", "username", "password", "name", "contact", "address", "email"};
        String data[][] = new String[al.size()][11];
        for (int i = 0; i < al.size(); i++) {
            UserBean objbean = (UserBean) al.get(i);
            data[i][0] = String.valueOf(objbean.getUserid());
            data[i][1] = objbean.getUsername();
            data[i][2] = objbean.getPassword();
            data[i][3] = objbean.getName();
            data[i][4] = objbean.getContactno();
            data[i][5] = objbean.getAddress();
    ...
    private ArrayList showSelected(String name) {
        ...
        try {
            ...
            String query = "Select * from usermaster where username is not null";
            if (!name.equals("")) {
    ...
    private void initComponents() {
        ...
        tblUserReports.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Username", "Name", "Usertype", "UserStatus", "Contact", "Email"
            }
        ) {
